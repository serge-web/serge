...
export { default as ChannelData, ChannelCollab, InitialStates } from './channel-data.d'
...
export { default as Participant, CollaborativePermission, ParticipantTemplate } from './participant.d'
