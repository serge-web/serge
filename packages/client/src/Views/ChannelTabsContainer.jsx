...
class ChannelTabsContainer extends Component {
  ...
  if (node.getName() === 'Mapping') return <Mapping forces={state.allForces} imageTop={imageTop} imageBottom={imageBottom} imageLeft={imageLeft} imageRight={imageRight}></Mapping>
