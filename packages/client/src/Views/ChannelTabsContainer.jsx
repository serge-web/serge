...
class ChannelTabsContainer extends Component {
  ...
  if (node.getName() === 'Mapping') return <Mapping currentWargame={state.currentWargame} selectedForce={state.selectedForce} forces={state.allForces} imageTop={imageTop} imageBottom={imageBottom} imageLeft={imageLeft} imageRight={imageRight}></Mapping>
