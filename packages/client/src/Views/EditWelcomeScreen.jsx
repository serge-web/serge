        ...
        <div className="flex-content flex-content--big flex-content--last welcome-page">
          ...
          <div className="flex-content flex-content--row">
            <div className="welcome-action-primary">
              <h5>Image</h5>
              <span className="image-upload-link" onClick={this.uploadImage}>
                Upload new image
              </span>
            </div>
            <Button
          ...
          <img
            alt="Serge logo"
            className="serge-custom-logo"
            src={this.props.gameInfo.imageUrl}
          />
          ...
          >
            {!this.state.editDescriptionMode && (
              <>
                ...
                {this.state.showDescriptionEditIcon && (
                  <FontAwesomeIcon
                    onMouseOver={this.mouseOverDescription}
                    className="edit-hover-icon"
                    icon={faPencilAlt}
