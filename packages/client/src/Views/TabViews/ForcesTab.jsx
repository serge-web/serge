...
class ForcesTab extends Component {
  ...
  checkUnique () {
    const curTab = this.props.wargame.currentTab
    const selectedForce = this.props.wargame.data[curTab].selectedForce.name
  ...
  saveForce = () => {
    const curTab = this.props.wargame.currentTab
    const selectedForceId = this.props.wargame.data[curTab].selectedForce.uniqid

    const newForceData = this.props.wargame.data[curTab].forces.find((f) => f.uniqid === selectedForceId)
  ...
  createForceEditor () {
    ...
    const isUmpire = this.props.wargame.data[curTab].forces.find((f) => f.name === selectedForce).isUmpire

    const forceName = typeof this.state.newForceName === 'string' ? this.state.newForceName : selectedForce
    const forceOverview = typeof this.state.newForceOverview === 'string' ? this.state.newForceOverview : this.props.wargame.data[curTab].forces.find((force) => force.name === selectedForce).overview
    const force = this.props.wargame.data[curTab].forces.find((force) => force.name === selectedForce)
    const forceIcon = force.iconURL || force.icon
    const forceColor = force.color
