...
describe('PlayerUi Message Actions', () => {
  it('Should set all feedback messages gained from db to state', () => {
    expect(setWargameFeedback(setAllFeedbackMessagesActoin.payload)).toEqual(setAllFeedbackMessagesActoin)
  })
})
...
describe('PlayerUi Message Reducers', () => {
  it('Should set SET_FEEDBACK_MESSAGES gained from db to state', () => {
    expect(reducer(state, setWargameFeedback(setAllFeedbackMessagesActoin.payload)))
      .toEqual(state)
  })
})
