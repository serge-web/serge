...
import dataLegacyAtlantic from './data/atlantic-cells'
import dataAtlantic from './data/north-atlantic-res3'
...
// provide new poly data
mapChannel.constraints.newGridCellsURL = './data/north-atlantic-res3'

async function fetchMock (url: string): Promise<any> {
...
const atlanticConstraints: MappingConstraints = {
  ...
  newGridCellsURL: `${serverPath}cells/north-atlantic-res3.json`
}
