...
describe('AdjudicationMessagesList component: ', () => {
  it('renders component correctly', () => {
    ...
    const tree = renderer
      .create(<AdjudicationMessagesList forces={forces} setSelectedItems={(): any => noop} template={planningMessageTemplatesMock[0]} gameDate={P9Mock.data.overview.gameDate} channel={planningChannel} hideForcesInChannel={false}
