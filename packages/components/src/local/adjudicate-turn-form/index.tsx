...
export const AdjudicateTurnForm: React.FC<PropTypes> = ({
  ...
  return (
    <div className={styles.adjudicate}>
      <AttributeEditor isOpen={attributeEditorOpen} onClose={closeModal} onSave={updateData} aTypes={manager && manager.getPlatformDetails().attributeTypes} data={attributes} />
      <TitleWithIcon
