...
/* Render component */
export const ChatMessageSetup: React.FC<Props> = ({ selectedForce, userId, forceName, selectedRole, selectedRoleName, chatChannel, isUmpire, turnPresentation }: Props) => {
  ...
  return (
    <React.Fragment>
      <ChatMessagesList
        ...
        messages={messages}
      />
      <ChatEntryForm from={selectedForce} isUmpire={isUmpire} channel={currentChannel} role={selectedRole} roleName={selectedRoleName} postBack={messageHandler} />
    </React.Fragment>
  )
}
