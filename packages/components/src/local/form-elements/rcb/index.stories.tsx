...
export const CompactCheckboxWithForce: React.FC = () => <RCB type="checkbox" compact={true} force={true} label="Visible to" options={forces} value={['Blue']} updateState={logData}/>
