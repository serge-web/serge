...
it('provides the correct when planning my force', () => {
  expect(assetDialogFor('Blue', 'Blue', [], [], Phase.Planning, WorldStatePanels.Control, 1, false)).toEqual(MapBarForms.Planning)
})
...
it('provides the correct when planning other force I can percieve', () => {
  expect(assetDialogFor('Blue', 'Red', ['blue'], [], Phase.Planning, WorldStatePanels.Control, 1, false)).toEqual(MapBarForms.Perception)
})

it('provides the correct when planning other force I cannot perceive', () => {
  expect(assetDialogFor('Blue', 'Red', [], [], Phase.Planning, WorldStatePanels.Control, 1, false)).toEqual(undefined)
})

it('provides the correct when click my force in adjudication', () => {
  expect(assetDialogFor('Blue', 'Blue', [], [], Phase.Adjudication, WorldStatePanels.Control, 1, false)).toEqual(MapBarForms.Planning)
})

it('provides the correct when click other force in adjudication in control tab', () => {
  expect(assetDialogFor('Blue', 'Red', [], [], Phase.Adjudication, WorldStatePanels.Control, 1, false)).toEqual(MapBarForms.Perception)
})

it('provides the correct when click other force in adjudication in control tab', () => {
  expect(assetDialogFor('Blue', 'Red', [], [], Phase.Adjudication, WorldStatePanels.Visibility, 1, false)).toEqual(MapBarForms.Perception)
})
...
it('provides the correct form when umpire clicks on non-controlled platform in adjudication in control tab', () => {
  expect(assetDialogFor('Umpire', 'Red', [], [], Phase.Adjudication, WorldStatePanels.Control, 1, false)).toEqual(MapBarForms.Adjudicaton)
})

it('provides the correct form when umpire clicks on non-controlled platform in adjudication in visibility tab', () => {
  expect(assetDialogFor('Umpire', 'Red', [], [], Phase.Adjudication, WorldStatePanels.Visibility, 1, false)).toEqual(MapBarForms.Visibility)
})

it('provides the correct form when umpire clicks on non-controlled platform in adjudication in controlled by tab', () => {
  expect(assetDialogFor('Umpire', 'Red', [], [], Phase.Adjudication, WorldStatePanels.ControlledBy, 1, false)).toEqual(undefined)
})
...
it('provides the correct form when umpire clicks on non-controlled platform in adjudication in control tab', () => {
  expect(assetDialogFor('Umpire', 'Red', [], [], Phase.Planning, WorldStatePanels.Control, 1, false)).toEqual(MapBarForms.Visibility)
})

it('provides the correct form when umpire clicks on non-controlled platform in adjudication in visibility tab', () => {
  expect(assetDialogFor('Umpire', 'Red', [], [], Phase.Planning, WorldStatePanels.Visibility, 1, false)).toEqual(MapBarForms.Visibility)
})
