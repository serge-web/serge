...
it('can set selected route', () => {
  ...
  // not set at start
  expect(store.forces[0].routes[2].selected).toEqual(false)
  ...
  expect(store2.forces[0].routes[2].selected).toEqual(true)
  ...
  expect(store3.forces[0].routes[2].selected).toEqual(false)
  ...
  expect(store4.forces[0].routes[2].selected).toEqual(true)
  ...
  expect(store5.forces[0].routes[2].selected).toEqual(false)
})
