...
const messageTemplatesMock: TemplateBody[] = [
...

  {
    ...
    details: {
      title: 'COA',
      schema: "{\"type\":\"object\",\"properties\":{\"Reference\":{\"title\":\"Reference (sys generated)\",\"type\":\"string\"},\"Title\":{\"title\":\"*COA / Op Name\",\"type\":\"string\"},\"LOCATION\":{\"title\":\"*Location of activities in this turn\",\"type\":\"object\",\"properties\":{\"region\":{\"enum\":[\"Asia Pacific\",\"Europe\",\"Americas\"],\"title\":\"Region\",\"type\":\"string\"},\"Europe\":{\"enum\":[\"United Kingdom\",\"Germany\"],\"title\":\"Country\",\"type\":\"string\"}},\"dependencies\":{},\"required\":[]},\"PRESCRIPTED\":{\"title\":\"*Is this a pre-scripted activity? E.g. DXP\",\"type\":\"boolean\",\"default\":true},\"VISIBILITY\":{\"enum\":[\"Overt\",\"Covert\",\"Clandestine\",\"Complex\"],\"title\":\"*Intended visibility to adversary\",\"type\":\"string\"},\"COA_SUPPORTS_AS\":{\"items\":{\"type\":\"string\"},\"title\":\"*This COA supports / uses an AS plan / effect\",\"type\":\"array\"},\"TARGET\":{\"title\":\"*Target(s) – Adversary, Ally, specific audience within Adversary or allied polity etc\",\"type\":\"string\"},\"STRAT_COMMS\":{\"title\":\"Outline of associated Strategic Communications\",\"type\":\"string\"},\"OBJECTIVES_TURN\":{\"title\":\"Objectives in this turn\",\"type\":\"string\"},\"OBJECTIVES_OVERALL\":{\"title\":\"Overall Objectives\",\"type\":\"string\"},\"TARGET_CENTRE_OF_GRAVITY\":{\"title\":\"Target’s Centre of Gravity\",\"type\":\"string\"},\"DESIRED_ENDSTATE_TURN\":{\"title\":\"*Desired Endstate in this turn\",\"type\":\"string\"},\"DESIRED_ENDSTATE_OVERALL\":{\"title\":\"Desired Endstate Overall, if NOT in this turn\",\"type\":\"string\"},\"EFFECTS_AND_ACTIONS\":{\"title\":\"*Effects and actions\",\"type\":\"string\"},\"SEQUENCING_AND_PHASES\":{\"title\":\"Sequencing and phases\",\"type\":\"string\"},\"ADVERSARY_UNDERSTANDING\":{\"title\":\"What would my adversary see / understand of this activity / messaging?\",\"type\":\"string\"},\"ADVERSARY_REACTION_COUNTER_ACTION\":{\"title\":\"Adversary reaction & counter-action\",\"type\":\"object\",\"properties\":{\"ADVERSARY_MLCOA\":{\"title\":\"Adversary MLCOA\",\"type\":\"string\"},\"MLCOA_RESPONSE\":{\"title\":\"Own Response\",\"type\":\"string\"},\"ADVERSARY_MDCOA\":{\"title\":\"Adversary MDCOA\",\"type\":\"string\"},\"MDCOA_RESPONSE\":{\"title\":\"Own Response\",\"type\":\"string\"}},\"dependencies\":{},\"required\":[]},\"ORBAT\":{\"items\":{\"type\":\"object\",\"properties\":{\"FEName\":{\"enum\":[\"Tank\",\"Infantry\",\"Plane\",\"Submarine\",\"other\"],\"title\":\"FE Name\",\"type\":\"string\"},\"Readiness\":{\"enum\":[\"Level-1\",\"Level-2\",\"Level-3\",\"Level-4\",\"Level-5\"],\"type\":\"string\"},\"Number\":{\"type\":\"string\"},\"StartDate\":{\"format\":\"date\",\"title\":\"Start date\",\"type\":\"string\"},\"EndDate\":{\"format\":\"date\",\"title\":\"End date\",\"type\":\"string\"}},\"dependencies\":{},\"required\":[]},\"title\":\"*ORBAT – FEs used (Inc logistics and enablers)\",\"type\":\"array\"},\"TIMINGS\":{\"title\":\"Timings\",\"type\":\"object\",\"properties\":{\"START_PLANNING\":{\"format\":\"date\",\"title\":\"Start planning\",\"type\":\"string\"},\"START_DEPLOYMENT\":{\"format\":\"date\",\"title\":\"Start deployment\",\"type\":\"string\"},\"START_OPERATION\":{\"format\":\"date\",\"title\":\"Start Operation\",\"type\":\"string\"},\"END_OPERATION\":{\"format\":\"date\",\"title\":\"End Operation\",\"type\":\"string\"},\"END_RECOVERY\":{\"format\":\"date\",\"title\":\"End recovery\",\"type\":\"string\"}},\"dependencies\":{},\"required\":[]},\"CONTINUES_INTO_NEXT_TURN\":{\"title\":\"*Will this activity continue into next turn?\",\"type\":\"boolean\",\"default\":true},\"DEPENDENCIES\":{\"title\":\"Dependencies on Allied capability: Please indicate which allies (if any) and which of their capabilities you are dependent on. E.g. US Space capabilities, Allied ABO\",\"type\":\"string\"},\"AdjudicationSupport\":{\"items\":{\"enum\":[\"Space\",\"CEMA\",\"Influence\",\"Logistics\"],\"type\":\"string\"},\"title\":\"Adjudication support\",\"type\":\"array\"},\"PEER_REVIEW\":{\"title\":\"Peer Review by\",\"type\":\"string\"},\"INSIGHT\":{\"title\":\"Insight – What would you have done differently with other policies / permissions / risk appetite?\",\"type\":\"string\"}},\"dependencies\":{},\"required\":[\"Reference\",\"Title\",\"PRESCRIPTED\",\"COA_SUPPORTS_AS\",\"STRAT_COMMS\",\"OBJECTIVES_TURN\",\"OBJECTIVES_OVERALL\",\"TARGET_CENTRE_OF_GRAVITY\",\"DESIRED_ENDSTATE_TURN\",\"DESIRED_ENDSTATE_OVERALL\",\"EFFECTS_AND_ACTIONS\",\"SEQUENCING_AND_PHASES\",\"ADVERSARY_REACTION_COUNTER_ACTION\",\"ORBAT\",\"PEER_REVIEW\",\"INSIGHT\"]}",
      uischema: "{\"LOCATION\":{\"ui:order\":[\"region\",\"Europe\"]},\"ADVERSARY_REACTION_COUNTER_ACTION\":{\"ui:order\":[\"ADVERSARY_MLCOA\",\"MLCOA_RESPONSE\",\"ADVERSARY_MDCOA\",\"MDCOA_RESPONSE\"]},\"ORBAT\":{\"items\":{\"ui:order\":[\"FEName\",\"Readiness\",\"Number\",\"StartDate\",\"EndDate\"]}},\"TIMINGS\":{\"ui:order\":[\"START_PLANNING\",\"START_DEPLOYMENT\",\"START_OPERATION\",\"END_OPERATION\",\"END_RECOVERY\"]},\"DEPENDENCIES\":{\"ui:widget\":\"textarea\"},\"AdjudicationSupport\":{\"items\":{}},\"PEER_REVIEW\":{\"ui:widget\":\"textarea\"},\"INSIGHT\":{\"ui:widget\":\"textarea\"},\"ui:order\":[\"Reference\",\"Title\",\"LOCATION\",\"PRESCRIPTED\",\"VISIBILITY\",\"COA_SUPPORTS_AS\",\"TARGET\",\"STRAT_COMMS\",\"OBJECTIVES_TURN\",\"OBJECTIVES_OVERALL\",\"TARGET_CENTRE_OF_GRAVITY\",\"DESIRED_ENDSTATE_TURN\",\"DESIRED_ENDSTATE_OVERALL\",\"EFFECTS_AND_ACTIONS\",\"SEQUENCING_AND_PHASES\",\"ADVERSARY_UNDERSTANDING\",\"ADVERSARY_REACTION_COUNTER_ACTION\",\"ORBAT\",\"TIMINGS\",\"CONTINUES_INTO_NEXT_TURN\",\"DEPENDENCIES\",\"AdjudicationSupport\",\"PEER_REVIEW\",\"INSIGHT\"]}"
    },
    lastUpdated: '2019-09-30T12:37:26.705Z',
    title: 'COA',
    _id: 'k16eedkk',
