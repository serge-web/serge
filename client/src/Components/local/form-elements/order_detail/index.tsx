...
import { PlannedActivityGeometry, PlanningActivity, PlanningActivityGeometry, PlatformTypeData } from 'src/custom-types'
import { PlanningMessageStructureCore } from 'src/custom-types/message'
